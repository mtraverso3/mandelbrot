    ...
    "Mandelbrot benchmarks": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "156616ed47a91194e0b99ca2c62ba1ac60224fd2",
          "message": "Add touch gestures, keyboard controls and high-resolution export",
          "timestamp": "2026-09-25T16:59:30-05:00",
          "tree_id": "c6780278bfd393841fbbad9f0fb64f15e57956ec",
          "url": "https://github.com/mtraverso3/mandelbrot/commit/156616ed47a91194e0b99ca2c62ba1ac60224fd2"
        },
        "date": 1790373690952,
        "tool": "customSmallerIsBetter",
        "benches": [
          {
            ...
            "range": "± 3.04",
            "unit": "ms",
            "extra": "1024x820, 1500 iterations, 4 threads; min 65.81 ms, max 75.24 ms, 15 samples; Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz"
          },
          {
            "name": "render/mandelbrot/flat",
            "value": 46.65,
            "range": "± 1.59",
            "unit": "ms",
            "extra": "1024x820, 1500 iterations, 4 threads; min 46.52 ms, max 53.98 ms, 22 samples; Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz"
          },
          {
            "name": "render/mini-mandelbrot/normal",
            "value": 976.03,
            "range": "± 36.13",
            "unit": "ms",
            "extra": "1024x820, 1500 iterations, 4 threads; min 973.47 ms, max 1065.84 ms, 5 samples; Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz"
          },
          {
            "name": "render/mini-mandelbrot/flat",
            "value": 694.87,
            "range": "± 2.32",
            "unit": "ms",
            "extra": "1024x820, 1500 iterations, 4 threads; min 693.40 ms, max 700.16 ms, 5 samples; Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz"
          },
          {
            "name": "render/spirals/normal",
            "value": 906.75,
            "range": "± 1.99",
            "unit": "ms",
            "extra": "1024x820, 1500 iterations, 4 threads; min 905.80 ms, max 910.55 ms, 5 samples; Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz"
          },
          {
            "name": "render/quad-spiral/normal",
            "value": 625.48,
            "range": "± 7.32",
            "unit": "ms",
            "extra": "1024x820, 1500 iterations, 4 threads; min 618.95 ms, max 636.82 ms, 5 samples; Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz"
          },
          {
            "name": "render/mandelbrot/normal/1-thread",
            "value": 125.73,
            "range": "± 0.06",
            "unit": "ms",
            "extra": "1024x820, 1500 iterations, 1 threads; min 125.67 ms, max 125.90 ms, 8 samples; Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz"
          },
          {
            "name": "render/mandelbrot/normal/full-res",
            "value": 823.88,
            "range": "± 3.88",
            "unit": "ms",
            "extra": "4096x3280, 1500 iterations, 4 threads; min 816.18 ms, max 824.86 ms, 3 samples; Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz"
          },
          {
            "name": "render/deep-seahorse/normal",
            "value": 768.59,
            "range": "± 3.57",
            "unit": "ms",
            "extra": "320x256, 30000 iterations, 4 threads; min 768.23 ms, max 775.97 ms, 3 samples; Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz"
          },
          {
            "name": "render/misiurewicz-1e100/normal",
            "value": 166.78,
            "range": "± 1.23",
            "unit": "ms",
            "extra": "1024x820, 3000 iterations, 4 threads; min 165.10 ms, max 168.96 ms, 6 samples; Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz"
          },
          {
            "name": "encode/png/full-res",
            "value": 61.11,
            "range": "± 0.48",
            "unit": "ms",
            "extra": "4096x3280, 5369 KiB; min 60.98 ms, max 62.94 ms, 17 samples; Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz"
          },
          {
            "name": "downsample/lanczos3/full-res",
            "value": 71.75,
            "range": "± 1.97",
            "unit": "ms",
            "extra": "4096x3280 -> 2048x1640; min 71.07 ms, max 79.21 ms, 14 samples; Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz"
          },
          {
            "name": "auto-iterations/mini-mandelbrot",
            "value": 35.54,
            "range": "± 0.72",
            "unit": "ms",
            "extra": "1024x820 view, chose 96000 iterations; min 34.92 ms, max 37.23 ms, 28 samples; Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz"
          },
          {
            "name": "auto-iterations/deep-seahorse",
            "value": 128.08,
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "524993e7e1ce69b653804f6216186f9ba3d79426",
          "message": "Fix the auto zoom stalling short of its next keyframe",
          "timestamp": "2026-09-25T18:41:19-05:00",
          "tree_id": "9898c006f74dbd3c066d82331d3ab21cf83dd78c",
          "url": "https://github.com/mtraverso3/mandelbrot/commit/524993e7e1ce69b653804f6216186f9ba3d79426"
        },
        "date": 1790379812461,
        "tool": "customSmallerIsBetter",
        "benches": [
          {
            ...
            "range": "± 4.63",
            "unit": "ms",
            "extra": "1024x820, 1500 iterations, 4 threads; min 51.45 ms, max 71.13 ms, 19 samples; INTEL(R) XEON(R) PLATINUM 8573C"
          },
          {
            "name": "render/mandelbrot/flat",
            "value": 37.82,
            "range": "± 0.85",
            "unit": "ms",
            "extra": "1024x820, 1500 iterations, 4 threads; min 37.40 ms, max 40.17 ms, 27 samples; INTEL(R) XEON(R) PLATINUM 8573C"
          },
          {
            "name": "render/mini-mandelbrot/normal",
            "value": 713.31,
            "range": "± 3.19",
            "unit": "ms",
            "extra": "1024x820, 1500 iterations, 4 threads; min 709.45 ms, max 718.22 ms, 5 samples; INTEL(R) XEON(R) PLATINUM 8573C"
          },
          {
            "name": "render/mini-mandelbrot/flat",
            "value": 515.84,
            "range": "± 2.08",
            "unit": "ms",
            "extra": "1024x820, 1500 iterations, 4 threads; min 514.66 ms, max 520.30 ms, 5 samples; INTEL(R) XEON(R) PLATINUM 8573C"
          },
          {
            "name": "render/spirals/normal",
            "value": 666.62,
            "range": "± 4.56",
            "unit": "ms",
            "extra": "1024x820, 1500 iterations, 4 threads; min 661.68 ms, max 675.70 ms, 5 samples; INTEL(R) XEON(R) PLATINUM 8573C"
          },
          {
            "name": "render/quad-spiral/normal",
            "value": 454.4,
            "range": "± 1.91",
            "unit": "ms",
            "extra": "1024x820, 1500 iterations, 4 threads; min 451.12 ms, max 456.02 ms, 5 samples; INTEL(R) XEON(R) PLATINUM 8573C"
          },
          {
            "name": "render/mandelbrot/normal/1-thread",
            "value": 119.32,
            "range": "± 0.56",
            "unit": "ms",
            "extra": "1024x820, 1500 iterations, 1 threads; min 118.65 ms, max 120.52 ms, 9 samples; INTEL(R) XEON(R) PLATINUM 8573C"
          },
          {
            "name": "render/mandelbrot/normal/full-res",
            "value": 654.82,
            "range": "± 5.29",
            "unit": "ms",
            "extra": "4096x3280, 1500 iterations, 4 threads; min 647.41 ms, max 660.34 ms, 3 samples; INTEL(R) XEON(R) PLATINUM 8573C"
          },
          {
            "name": "render/deep-seahorse/normal",
            "value": 717.5,
            "range": "± 3.1",
            "unit": "ms",
            "extra": "320x256, 30000 iterations, 4 threads; min 714.89 ms, max 722.37 ms, 3 samples; INTEL(R) XEON(R) PLATINUM 8573C"
          },
          {
            "name": "render/misiurewicz-1e100/normal",
            "value": 153.11,
            "range": "± 0.93",
            "unit": "ms",
            "extra": "1024x820, 3000 iterations, 4 threads; min 151.64 ms, max 154.13 ms, 7 samples; INTEL(R) XEON(R) PLATINUM 8573C"
          },
          {
            "name": "encode/png/full-res",
            "value": 63.41,
            "range": "± 0.42",
            "unit": "ms",
            "extra": "4096x3280, 5369 KiB; min 62.75 ms, max 64.73 ms, 16 samples; INTEL(R) XEON(R) PLATINUM 8573C"
          },
          {
            "name": "downsample/lanczos3/full-res",
            "value": 56.51,
            "range": "± 0.99",
            "unit": "ms",
            "extra": "4096x3280 -> 2048x1640; min 55.70 ms, max 60.32 ms, 18 samples; INTEL(R) XEON(R) PLATINUM 8573C"
          },
          {
            "name": "auto-iterations/mini-mandelbrot",
            "value": 37.03,
            "range": "± 1.73",
            "unit": "ms",
            "extra": "1024x820 view, chose 96000 iterations; min 36.19 ms, max 45.26 ms, 27 samples; INTEL(R) XEON(R) PLATINUM 8573C"
          },
          {
            "name": "auto-iterations/deep-seahorse",
            "value": 116.21,
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "e909ed30706a276dab8600d247b7d245df0030b3",
          "message": "Smooth the auto zoom's turns and speed changes",
          "timestamp": "2026-09-25T19:12:31-05:00",
          "tree_id": "b860627b2bcd8df0fcf7966a63428a0d2a08d051",
          "url": "https://github.com/mtraverso3/mandelbrot/commit/e909ed30706a276dab8600d247b7d245df0030b3"
        },
        "date": 1790381651159,
        "tool": "customSmallerIsBetter",
        "benches": [
          {
            ...
            "range": "± 3.04",
            "unit": "ms",
            "extra": "1024x820, 1500 iterations, 4 threads; min 45.71 ms, max 58.28 ms, 21 samples; AMD EPYC 9V74 80-Core Processor"
          },
          {
            "name": "render/mandelbrot/flat",
            "value": 35.56,
            "range": "± 1.37",
            "unit": "ms",
            "extra": "1024x820, 1500 iterations, 4 threads; min 34.30 ms, max 40.01 ms, 29 samples; AMD EPYC 9V74 80-Core Processor"
          },
          {
            "name": "render/mini-mandelbrot/normal",
            "value": 634.96,
            "range": "± 8.4",
            "unit": "ms",
            "extra": "1024x820, 1500 iterations, 4 threads; min 633.15 ms, max 655.36 ms, 5 samples; AMD EPYC 9V74 80-Core Processor"
          },
          {
            "name": "render/mini-mandelbrot/flat",
            "value": 502.31,
            "range": "± 19.7",
            "unit": "ms",
            "extra": "1024x820, 1500 iterations, 4 threads; min 499.20 ms, max 551.03 ms, 5 samples; AMD EPYC 9V74 80-Core Processor"
          },
          {
            "name": "render/spirals/normal",
            "value": 590.96,
            "range": "± 2.09",
            "unit": "ms",
            "extra": "1024x820, 1500 iterations, 4 threads; min 589.96 ms, max 595.57 ms, 5 samples; AMD EPYC 9V74 80-Core Processor"
          },
          {
            "name": "render/quad-spiral/normal",
            "value": 403.95,
            "range": "± 0.23",
            "unit": "ms",
            "extra": "1024x820, 1500 iterations, 4 threads; min 403.68 ms, max 404.29 ms, 5 samples; AMD EPYC 9V74 80-Core Processor"
          },
          {
            "name": "render/mandelbrot/normal/1-thread",
            "value": 103.09,
            "range": "± 0.09",
            "unit": "ms",
            "extra": "1024x820, 1500 iterations, 1 threads; min 102.91 ms, max 103.16 ms, 10 samples; AMD EPYC 9V74 80-Core Processor"
          },
          {
            "name": "render/mandelbrot/normal/full-res",
            "value": 574.28,
            "range": "± 1.44",
            "unit": "ms",
            "extra": "4096x3280, 1500 iterations, 4 threads; min 571.33 ms, max 574.49 ms, 3 samples; AMD EPYC 9V74 80-Core Processor"
          },
          {
            "name": "render/deep-seahorse/normal",
            "value": 511.34,
            "range": "± 4.96",
            "unit": "ms",
            "extra": "320x256, 30000 iterations, 4 threads; min 502.10 ms, max 513.55 ms, 3 samples; AMD EPYC 9V74 80-Core Processor"
          },
          {
            "name": "render/misiurewicz-1e100/normal",
            "value": 119.32,
            "range": "± 0.58",
            "unit": "ms",
            "extra": "1024x820, 3000 iterations, 4 threads; min 118.41 ms, max 120.13 ms, 9 samples; AMD EPYC 9V74 80-Core Processor"
          },
          {
            "name": "encode/png/full-res",
            "value": 45.97,
            "range": "± 0.26",
            "unit": "ms",
            "extra": "4096x3280, 5369 KiB; min 45.83 ms, max 46.81 ms, 22 samples; AMD EPYC 9V74 80-Core Processor"
          },
          {
            "name": "downsample/lanczos3/full-res",
            "value": 48.22,
            "range": "± 0.57",
            "unit": "ms",
            "extra": "4096x3280 -> 2048x1640; min 47.87 ms, max 50.60 ms, 21 samples; AMD EPYC 9V74 80-Core Processor"
          },
          {
            "name": "auto-iterations/mini-mandelbrot",
            "value": 30.73,
            "range": "± 0.7",
            "unit": "ms",
            "extra": "1024x820 view, chose 96000 iterations; min 28.96 ms, max 32.18 ms, 33 samples; AMD EPYC 9V74 80-Core Processor"
          },
          {
            "name": "auto-iterations/deep-seahorse",
            "value": 87.09,
